...
def test_invalid_timeframe_raises_value_error(data_handler_instance):
    ...
    with pytest.raises(ValueError):
        data_handler_instance.retrieve_data(trading_pair, interval, candlestick_limit)
...
def test_returned_price_data_has_correct_trading_pair(data_handler_instance):
    ...
    with patch("requests.get") as mock_get:
        ...
        price_data = data_handler_instance.retrieve_data(trading_pair, interval, candlestick_limit)
